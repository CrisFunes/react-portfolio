...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_ixixzei', 'template_bczwisj', formRef.current, {
        publicKey: 'lxOfmwSdwQQqPosJM',
      })
      .then(
        () => {
            setSuccess(true)
        ...
        animate={controls}>
            <motion.div className="textContainer" variants={variants}>
                ...
                <motion.div variants={variants} className="item">
                    <h2>Mail</h2>
                    <span>cristianfunesdev@gmail.com</span>
                </motion.div>
                <motion.div variants={variants} className="item">
                    <h2>Linkedin</h2>
                    <a href="https://www.linkedin.com/in/cristian-funes-in/">cristian-funes-in</a>
                </motion.div>
                <motion.div variants={variants} className="item">
                    <h2>Git Hub</h2>
